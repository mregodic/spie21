...
The code was inspired by: 
 ...
 - [TRE estimation](https://github.com/mregodic/spie21/TRE_Fitzpatrick.py)
) by J. Michael Fitzpatrick, J. B. West, and C. R. Maurer, "Predicting error in rigid-body point-based registration," IEEE Trans. Med. Imaging 17(5), pp. 694-702, 1998
  
 ![](https://github.com/mregodic/spie21/images/unet.jpg?raw=true)
